...
<template>
  <VeeForm v-slot="{ handleSubmit, handleReset }" as="div">
    <form
        @submit="handleSubmit($event, fieldsValues => $emit('formSubmit', {$event, fieldsValues}, handleReset))"
        class="default-form review-form"
    >
      <label
      ...
      <div class="default-form__label j">
        <button type="submit" class="btn btn--big default-form__submit">Добавить</button>
      </div>
