...
<template>
  <VeeForm v-slot="{ handleSubmit, handleReset }" as="">
    <form
        @submit="handleSubmit($event, fieldsValues => $emit('formUpdate', {$event, fieldsValues}))"
        class="default-form default-form__review-update"
    >
      <label
      ...
      <div class="default-form__label j">
        <button type="submit" class="btn btn--big default-form__submit">Обновить</button>
      </div>
